...
// This handler finds and returns all the job interviews to the signed in user from the db.

export default async function getJobInterviewsByProfile(
  ...
  // STEP 3: Find job interviews by user id.
